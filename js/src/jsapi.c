...
JS_GetArgumentsClass(void)
{
  return &js_ArgumentsClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetArrayClass(void)
{
  return &js_ArrayClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetBooleanClass(void)
{
  return &js_BooleanClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetCallClass(void)
{
  return &js_CallClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetFunctionClass(void)
{
  return &js_FunctionClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetNumberClass(void)
{
  return &js_NumberClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetObjectClass(void)
{
  return &js_ObjectClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetRegExpClass(void)
{
  return &js_RegExpClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetScriptClass(void)
{
  return &js_ScriptClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetStringClass(void)
{
  return &js_StringClass;
}

JS_PUBLIC_API(JSClass *) 
JS_GetWithClass(void)
{
  return &js_WithClass;
}
...
{
  return js_ReportIsNotFunction(cx, vp, flags);
}
  
JS_PUBLIC_API(JSBool)
JS_IsDelegate(JSContext *cx, JSObject *obj, jsval v, JSBool *bp)
{
  return js_IsDelegate(cx, obj, v, bp);
}
