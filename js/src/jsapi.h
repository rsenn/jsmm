...
#if JS_ARGUMENT_FORMATTER_DEFINED
...
extern JS_PUBLIC_API(JSClass *) JS_GetArgumentsClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetArrayClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetBooleanClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetCallClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetFunctionClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetNumberClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetObjectClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetRegExpClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetScriptClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetStringClass(void);
extern JS_PUBLIC_API(JSClass *) JS_GetWithClass(void);
